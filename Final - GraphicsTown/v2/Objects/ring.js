...
grobjects.push(new Ring("ring2",[0,0,-4], [1,0,0], 7/10, [0,0,0]));
grobjects.push(new Ring("ring3",[0,0,-4.01], [1,.75,0], 6/10, [0,0,0]));
grobjects.push(new Ring("ring4",[0,0,-4], [1,1,0], 5/10, [0,0,0]));
grobjects.push(new Ring("ring5",[0,0,-4], [0,1,0], 4/10, [0,0,0]));
grobjects.push(new Ring("ring6",[0,0,-4.01], [0,0,1], 3.5/10, [0,0,0]));
grobjects.push(new Ring("ring7",[0,0,-4.02], [.35,.35,1], 3/10, [0,0,0]));
grobjects.push(new Ring("ring8",[0,0,-4], [1,0,1], 2.5/10, [0,0,0]));
